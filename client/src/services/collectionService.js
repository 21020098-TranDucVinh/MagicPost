...
// // get collection by ID
const getParcelsFromAnotherNode = (collection_zip_code, accessToken) => {
...
export { handleCollectionCreateNewStaff, getCollectionStaffById, getParcelsFromAnotherNode, getAllParcelsService };
