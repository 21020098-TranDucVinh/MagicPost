...
class ModalSendParcelToReceiver extends Component {
  ...
  render() {
    let { isOpen, parcelListToReceiver } = this.props;
        ...
        <Modal className="modal-admin-container" isOpen={isOpen} size="xl" centered>
          <div className="modal-admin-content">
            ...
            <div className="modal-admin-footer">
              <button className={'btn btn-primary'} onClick={() => this.handleSendParcelToReceiver()}>
                Send
              </button>
...
const mapDispatchToProps = (dispatch) => {
  return {
    getALlReceivedParcels: (zip_code, accessToken) => dispatch(actions.getALlReceivedParcels(zip_code, accessToken)),
  };
};
