          ...
          <div className="system-container">
            <div className="system-list container">
              <Switch>
                ...
                <Route exact path={path.ADMIN_MANAGE_COLLECTION_AND_TRANSACTION} component={AdminManagement} />
                <Route exact path={'/system/director/statistics/parcels'} component={AdminStatisticParcel} />
                <Route exact path={path.ADMIN_MANAGE_TRANSACTION} component={ManageTransaction} />
                <Route exact path={path.ADMIN_MANAGE_COLLECTION} component={ManagementCollection} />
              </Switch>
            </div>
          </div>
        </div>
