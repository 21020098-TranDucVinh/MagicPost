        ...
        <div className="board-of-director-container">
          ...
          <div className="system-container">
            <div className="system-list container">
              <Switch>
                <Route path="/collection-admin/manager/create-account" component={ManageCollectionStaff} />
                <Route path="/collection-admin/manager/statistic-parcel" component={TranStaffStatisticParcel} />
              </Switch>
            </div>
          </div>
        </div>
