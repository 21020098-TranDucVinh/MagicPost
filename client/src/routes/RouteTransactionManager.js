        ...
        <div className="board-of-director-container">
          ...
          <div className="system-container">
            <div className="system-list container">
              <Switch>
                <Route path="/transaction-admin/manager/create-account" component={ManageStaffTransaction} />
                <Route path="/transaction-admin/manager/statistic-parcel" component={TranStaffStatisticParcel} />
              </Switch>
            </div>
          </div>
        </div>
